...
Public Class Jeu
    ...
    Public Sub CheminFichierF2(cheminfichier As String)
    ...
    Private Async Sub Card_Click(sender As Object, e As EventArgs)
        ...
        If cpt_devo = 4 AndAlso EstCarre = False Then
            ...
            For i As Integer = 0 To 3
                liste_devo(i).BackgroundImage = back_card
                Dim index_label As Integer
                Integer.TryParse(New String(liste_devo(i).Name.Where(AddressOf Char.IsDigit).ToArray()), index_label)
